...
Config.instname = "Universität Konstanz"
Config.profilename = "Uni Konstanz"
Config.url = " \
    ""https://www.kim.uni-konstanz.de/e-mail-und-internet/wlan/wlan-zugang/"
Config.email = "support@uni-konstanz.de"
Config.title = "eduroam CAT"
Config.server_match = "radius.kim.uni-konstanz.de"
...
Config.user_realm = "uni-konstanz.de"
Config.ssids = ['eduroam']
Config.del_ssids = []
Config.servers = ['DNS:radius.kim.uni-konstanz.de']
Config.use_other_tls_id = False
Config.anonymous_identity = "eduroam@uni-konstanz.de"
Config.tou = ""
